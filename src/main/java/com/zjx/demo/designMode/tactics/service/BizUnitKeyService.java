 ...
 **/
@Service
public class BizUnitKeyService {
    ...
    public void checkResultDispatcherInit(){
        ...
        checkResultDispatcher.put("key_订单2", order -> bizUnitService.bizTwo(order));
        checkResultDispatcher.put("key_订单3", order -> bizUnitService.bizThree(order));
    }
