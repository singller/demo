...
public class PgpUtils {
    ...
    public PGPPublicKey readPublicKey(InputStream in) throws IOException, PGPException {
        ...
        PGPPublicKeyRingCollection pgpPub = new PGPPublicKeyRingCollection((Collection<PGPPublicKeyRing>) PGPUtil.getDecoderStream(in));
...
//        PGPObjectFactory pgpF = new PGPObjectFactory(in);
    ...
    private boolean verifySignature(String fileName, byte[] b, InputStream keyIn) throws GeneralSecurityException, IOException, PGPException {
        ...
        PGPPublicKeyRingCollection pgpPubRingCollection = new PGPPublicKeyRingCollection((Collection<PGPPublicKeyRing>) PGPUtil.getDecoderStream(keyIn));
